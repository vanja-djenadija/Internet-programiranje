CREATE DATABASE  IF NOT EXISTS `ip2023` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `ip2023`;
-- MySQL dump 10.13  Distrib 8.0.28, for Win64 (x86_64)
--
-- Host: localhost    Database: ip2023
-- ------------------------------------------------------
...
-- Dump completed on 2023-08-30 14:12:21
